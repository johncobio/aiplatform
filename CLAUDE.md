...
make policy       # OPA suites; make guard runs the full proposal guardrails on the tree
```
...
- The proposal agent validates on a scratch worktree from `main`: anything a
